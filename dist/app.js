...
function changeProject(projectNode, index) {
    ...
    if (index === "Today" || index === "This Week") {
        ...
        workspaceTitle.textContent = _projects_js__WEBPACK_IMPORTED_MODULE_1__.projects[index].title;
...
function createTaskUI(task, index, projectIndex) {
    ...
    const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.date, "E MMM dd, yyyy");
...
function setEditFormValues() {
    ...
    const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(currTask.date, "yyyy-MM-dd");
