...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/compareAsc/index.js");
    ...
    switch (_ui_projects_js__WEBPACK_IMPORTED_MODULE_2__.activeTab) {
        case "Today":
            return _tasks_js__WEBPACK_IMPORTED_MODULE_0__.tasksHandler.items.filter((task, index) => {
                task.arrIndex = index;
                return (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(task.date);
            });
        case "This Week":
            return _tasks_js__WEBPACK_IMPORTED_MODULE_0__.tasksHandler.items.filter((task, index) => {
                task.arrIndex = index;
                return (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(task.date);
            });
        default:
...
function sortTasks(tasksArr, sortMethod) {
    if (sortMethod === "asc") {
        return tasksArr.sort((a, b) => (0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(a.date, b.date));
