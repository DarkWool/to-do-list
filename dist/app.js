...
function composeNewTask(title, details, date, priority) {
    ...
    if (_projects_js__WEBPACK_IMPORTED_MODULE_0__.projects[_projects_js__WEBPACK_IMPORTED_MODULE_2__.activeTab].tasks[0] == null) cleanTasksContainer();
