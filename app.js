...
function getNewTaskData(e) {
    ...
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date) === false) {
        date = null;
    }
...
function createTaskUI(task, taskIndex) {
    ...
    if (task.date !== null) {
        taskDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(task.date, "E MMM dd, yyyy");
    } else {
...
function setEditFormValues() {
    ...
    if (currTask.date !== null) {
        let date = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(currTask.date, "yyyy-MM-dd");
...
function editTask(e) {
    ...
    if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date) === true) {
        currTask.date = date;
    } else {
        currTask.date = null;
    }
